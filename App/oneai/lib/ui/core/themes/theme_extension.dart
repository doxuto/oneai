...
/// Custom theme extension for additional app-specific theme values
class AppThemeExtension extends ThemeExtension<AppThemeExtension> {
  ...
  ThemeExtension<AppThemeExtension> lerp(ThemeExtension<AppThemeExtension>? other, double t) {
    ...
    return AppThemeExtension(
      ...
      onSuccessContainerColor: Color.lerp(onSuccessContainerColor, other.onSuccessContainerColor, t)!,
      ...
      onWarningContainerColor: Color.lerp(onWarningContainerColor, other.onWarningContainerColor, t)!,
      // Radius and Duration don't support lerp, so we just use the target value
...
/// Extension method to easily access app theme from BuildContext
extension AppThemeContextExtension on BuildContext {
  ...
  AppThemeExtension get appTheme => theme.extension<AppThemeExtension>() ?? AppThemeExtension.light;
}
