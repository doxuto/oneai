...
import { generateCalendarEventsHandler } from "./handler.js";
...
export const generateCalendarEvents = onCall(
  ...
  (request: CallableRequest<unknown>) => generateCalendarEventsHandler(callerOf(request), request.data, liveDeps()),
);
